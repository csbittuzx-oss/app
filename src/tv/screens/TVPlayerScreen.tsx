      ...
      >
        <div
          style={{
            ...
            borderRadius: '24px',
            overflow: 'hidden',
            boxShadow: '0 24px 64px rgba(0, 0, 0, 0.8), 0 0 32px rgba(99, 102, 241, 0.25)',
        ...
        >
          ...
          >
            {state.isPlaying ? (
              ...
              <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" style={{ marginLeft: 3 }}>
      ...
      >
        ...
        >
          ...
          {state.queue.length <= state.queueIndex + 1 && (
            <div style={{ color: '#A1A1AA', padding: '24px 0', textAlign: 'center' }}>
