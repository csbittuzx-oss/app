...
export function PlaylistScreen() {
  ...
  const rawArtwork = playlist.artwork || (verifiedTracks[0]?.artworkLg || verifiedTracks[0]?.artwork);
  const artworkSrc = resizeImageUrl(rawArtwork, 1200, 1200) || CONFIG.ARTWORK_PLACEHOLDER;
